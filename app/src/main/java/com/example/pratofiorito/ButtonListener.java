...
public class ButtonListener implements View.OnClickListener {
    ...
    ButtonListener(Field f) {
        ...
        ga = f.getContext();
        chr = new Chronometer();
        //alla generazione del campo starto un cronometro che servirà a determinare la durata della partita
        chr.start();
    }
    ...
    //in caso di vittoria fermo il cronometro, genero i dato che potrebbero venir salvati
    private void win() {
        chr.stop();
    ...
    private void replacePressed(int B_id) {
        int[] pos = f.getButtonCoordinates(B_id);
